...
public extension NotificationCenter {
    ...
    /// - Parameter notifications: The names of the notification to register for delivery to the observer. Specify a notification name to deliver only entries with this notification name.
    ///
    func addObserverNotifications(_ observer: Any, selector: Selector, notifications: [Notification.Name]) {
